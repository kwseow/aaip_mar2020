...
def visualize_detections(image, masks, class_ids):
    ...
    for i in range(masks.shape[2]):
        ...
        masked_image = mrcnn.visualize.apply_mask(
            masked_image,
            mask,
            color,
            alpha=1.0
    ...
    # Use the Dialate Morphological operation
    # to find large blobs of people
    ...
    # Convert the masked image to pure black
    # and white (1-bit)
...
# Visualize results
r = results[0]
masked_image = visualize_detections(
    rgb_image,
    r['masks'],
    r['class_ids']
)
